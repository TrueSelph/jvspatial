...
class TestDatabaseFactory:
    ...
    def setup_method(self):
        ...
        self.original_env = {}
        env_vars = ["JVSPATIAL_DB_TYPE", "JVSPATIAL_JSONDB_PATH", "JVSPATIAL_MONGODB_URI", "JVSPATIAL_MONGODB_DB_NAME"]
        for var in env_vars:
...
class TestMongoDBConfiguration:
    ...
    def setup_method(self):
        """Reset environment variables"""
        self.original_env = {}
        env_vars = ["JVSPATIAL_DB_TYPE", "JVSPATIAL_MONGODB_URI", "JVSPATIAL_MONGODB_DB_NAME"]
        for var in env_vars:
            self.original_env[var] = os.environ.get(var)
            if var in os.environ:
                del os.environ[var]
...
class TestFactoryErrorHandling:
    ...
    def test_mongodb_import_failure_handling(self):
        ...
        with patch('jvspatial.db.factory.MongoDB', side_effect=ImportError("MongoDB not available")):
