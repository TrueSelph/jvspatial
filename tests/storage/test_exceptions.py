...
class TestPathTraversalError:
    ...
    def test_can_be_raised_and_caught_as_storage_error(self):
...
class TestValidationError:
    ...
    def test_init_with_validation_type_and_kwargs(self):
    ...
    def test_init_with_none_validation_type(self):
    ...
    def test_kwargs_are_stored_in_details(self):
...
class TestFileSizeLimitError:
    ...
    def test_init_with_file_size(self):
    ...
    def test_init_with_both_sizes(self):
    ...
    def test_validation_type_is_size(self):
...
class TestInvalidMimeTypeError:
    ...
    def test_init_with_detected_type(self):
    ...
    def test_init_with_expected_type(self):
    ...
    def test_init_with_both_types(self):
    ...
    def test_validation_type_is_mime_type(self):
...
class TestEdgeCases:
    ...
    def test_exception_with_newlines_in_message(self):
    ...
    def test_details_with_complex_data_types(self):
    ...
    def test_modifying_details_after_creation(self):
...
def test_exceptions_available_from_main_module():
