...
class TestDefaultProviderSelection:
    ...
    async def test_default_provider_is_local(self, clean_env, temp_dir):
    ...
    async def test_default_provider_without_root_dir(self, clean_env):
...
class TestExplicitProviderSelection:
    ...
    async def test_explicit_local_provider(self, clean_env, temp_dir):
        """Test explicitly selecting local provider."""
        storage = get_file_interface(provider="local", root_dir=temp_dir)

        assert isinstance(storage, LocalFileInterface)

    async def test_explicit_local_provider_uppercase(self, clean_env, temp_dir):
        """Test that provider name is case-insensitive."""
        storage = get_file_interface(provider="LOCAL", root_dir=temp_dir)

        assert isinstance(storage, LocalFileInterface)

    async def test_explicit_s3_provider(self, clean_env):
    ...
    async def test_explicit_s3_provider_uppercase(self, clean_env):
...
class TestEnvironmentVariableProviderSelection:
    ...
    async def test_env_var_local_provider(self, temp_dir):
    ...
    async def test_env_var_s3_provider(self):
    ...
    async def test_parameter_overrides_env_var(self, temp_dir):
...
class TestConfigurationMerging:
    ...
    async def test_config_dict_only(self, temp_dir):
    ...
    async def test_kwargs_only(self, temp_dir):
    ...
    async def test_kwargs_override_config(self, temp_dir):
    ...
    async def test_config_dict_and_kwargs_merge(self, temp_dir):
...
class TestRootDirParameter:
    ...
    async def test_root_dir_parameter(self, temp_dir):
        """Test that root_dir parameter is used."""
        storage = get_file_interface(provider="local", root_dir=temp_dir)

        assert storage.root_dir.name == os.path.basename(temp_dir)

    async def test_root_dir_from_config(self, temp_dir):
        """Test root_dir from config dict."""
        storage = get_file_interface(provider="local", config={"root_dir": temp_dir})

        assert storage.root_dir.name == os.path.basename(temp_dir)

    async def test_root_dir_parameter_overrides_config(self, temp_dir):
    ...
    async def test_default_root_dir_used_when_none_provided(self, clean_env):
...
class TestCustomValidatorConfiguration:
    ...
    async def test_validator_with_max_size(self, temp_dir):
    ...
    async def test_validator_with_allowed_mime_types(self, temp_dir):
    ...
    async def test_validator_with_both_settings(self, temp_dir):
    ...
    async def test_no_custom_validator_when_not_configured(self, temp_dir):
...
class TestLocalFileInterfaceCreation:
    ...
    async def test_local_with_base_url(self, temp_dir):
    ...
    async def test_local_with_create_root_true(self):
    ...
    async def test_local_with_create_root_false(self, temp_dir):
    ...
    async def test_local_with_all_parameters(self, temp_dir):
...
class TestS3FileInterfaceCreation:
    ...
    async def test_s3_with_bucket_name(self, mock_boto3):
    ...
    @patch("jvspatial.storage.interfaces.s3.boto3")
    async def test_s3_with_region(self, mock_boto3):
    ...
    @patch("jvspatial.storage.interfaces.s3.boto3")
    async def test_s3_with_credentials(self, mock_boto3):
    ...
    @patch("jvspatial.storage.interfaces.s3.boto3")
    async def test_s3_with_custom_endpoint(self, mock_boto3):
    ...
    @patch("jvspatial.storage.interfaces.s3.boto3")
    async def test_s3_with_url_expiration(self, mock_boto3):
    ...
    @patch("jvspatial.storage.interfaces.s3.boto3")
    async def test_s3_with_custom_validator(self, mock_boto3):
...
class TestInvalidProviderRejection:
    ...
    async def test_unknown_provider_raises_error(self, clean_env):
    ...
    async def test_error_lists_available_providers(self, clean_env):
    ...
    async def test_empty_provider_uses_default(self, clean_env, temp_dir):
    ...
    async def test_none_provider_uses_default(self, clean_env, temp_dir):
...
class TestProviderInitializationErrorHandling:
    ...
    async def test_local_missing_directory_error(self, clean_env):
    ...
    @patch("jvspatial.storage.interfaces.s3.boto3")
    async def test_s3_initialization_wraps_errors(self, mock_boto3):
    ...
    async def test_local_initialization_error_wrapped(self, mock_init, temp_dir):
...
class TestBackwardCompatibility:
    ...
    async def test_file_interface_type_constant_exists(self):
        """Test that FILE_INTERFACE_TYPE constant exists."""
        assert FILE_INTERFACE_TYPE is not None

    async def test_default_files_root_constant_exists(self):
        """Test that DEFAULT_FILES_ROOT constant exists."""
        assert DEFAULT_FILES_ROOT is not None

    async def test_file_interface_type_default_value(self, clean_env):
    ...
    async def test_default_files_root_default_value(self, clean_env):
    ...
    async def test_env_var_affects_constant(self):
...
class TestEdgeCases:
    ...
    async def test_whitespace_provider_name(self, temp_dir):
    ...
    async def test_config_with_unexpected_keys(self, temp_dir):
    ...
    async def test_multiple_instantiations(self, temp_dir):
...
async def test_factory_module_imports():
