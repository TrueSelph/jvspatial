...
from jvspatial.core.entities import (
    Node, Walker, Edge, on_visit, on_exit,
    find_subclass_by_name, _register_hook
)
...
class TestSpatialFunctions:
    ...
    def test_calculate_distance_edge_cases(self):
        ...
        distance = calculate_distance(
            extreme_lat1, extreme_lon1,
            extreme_lat2, extreme_lon2
        )
...
class TestCoordinateValidation:
    ...
    def test_extreme_coordinate_values(self):
        ...
        assert abs(distance2) < 1e-10  # -180 and 180 are the same meridian (allow for floating point precision)
